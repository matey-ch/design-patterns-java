public class Espresso extends Beverage {
    ...
    private static double waterAmount = 0.1;
    private static double grainsAmount = 0.5;
    private static double[] multipliers = new double[]{0.75,1,1.5};

    public Espresso(double waterCost, double grainsCost, double sugarCost, double[] prices){
